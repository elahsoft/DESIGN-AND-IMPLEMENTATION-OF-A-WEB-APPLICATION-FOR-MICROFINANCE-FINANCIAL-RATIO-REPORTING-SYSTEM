...
<div class="row" id="internal">
    <div class="col-lg-2 col-md-2 col-sm-2" id="internal-label">
        <h2>Bank Statement Entry</h2>
    </div>
    <div class="col-lg-10 col-md-10 col-sm-10" id="internal-entry-text">
        <p> You prepare your Bank Account Entries here and also view past entries. Please,
            note the auto-generated Last Closing Bal. and reference numbers for reversal purposes. </p>
    </div>
</div>
    ...
    <div class="col-lg-8 col-md-8 col-sm-8"  id="internal-entry-form">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                ...
                <input type="text" name="reference-number" id="reference-number" class="form-control" />
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                <label for="Financial Date or Value At">Financial Date/ Value At:</label>
                <input type="date" name="financial-date" id="financial-date" class="form-control"/>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
