<?php
    ...
    class AdjustedReturnOnAssets extends database{

        private $fieldsArray = array("period_id", "adjusted_net_operating_income", "taxes", 
        "adjusted_average_assets", "date",  "status");
        private $tableName = "ra_adjusted_return_on_assets";
        ...
        public function computeAdjustedReturnOnAssets($adjusted_net_operating_income, $taxes, $adjusted_average_assets) {
            $adjusted_return_on_assets = ($adjusted_net_operating_income - $taxes) / $adjusted_average_assets;
            return $adjusted_return_on_assets;
        }
    }
