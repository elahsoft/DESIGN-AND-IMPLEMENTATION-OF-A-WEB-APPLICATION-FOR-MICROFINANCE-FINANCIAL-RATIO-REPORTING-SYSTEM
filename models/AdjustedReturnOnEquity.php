<?php
    ...
    class AdjustedReturnOnEquity extends database{

        private $fieldsArray = array("period_id", "adjusted_average_equity", "date",  "status");
        private $tableName = "ra_adjusted_return_on_equity";
        ...
        public function computeAdjustedReturnOnEquity($adjusted_net_operating_income, $taxes, $adjusted_average_equity) {
            if ($adjusted_average_equity)
                $adjusted_return_on_equity = ($adjusted_net_operating_income - $taxes) / $adjusted_average_equity;
            else
                $adjusted_return_on_equity = 0;
            return $adjusted_return_on_equity;
        }
    }
